...
/// enhancing a resumes job description 
...
export const uploadResume = async (req, res) => {
  try {
    ...
    const userPrompt = `extract data from this resume: ${resumeText}  Provide data in the following JSON format with no additional text before and the after :
